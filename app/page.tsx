...
import EcomProducts from "../app/Components/products"; // Import the Products component
...
export default function Home({ products }: { products: Product[] }) {
        ...
        <div className="relative flex flex-col items-center justify-center overflow-hidden rounded-md">
          <div className="hero min-h-screen">
            <div className="hero-content flex-col lg:flex-row-reverse">
              <Image className="max-w-sm rounded-lg shadow-2xl" src={ecomimg} alt="hero image" />
              <div>
                <h1 className="text-5xl font-bold text-white">Supply & Co</h1>
                <p className="py-6 text-white">Elevate Your Lifestyle with Premium Goods and Unmatched Convenience.</p>
  ...
  Get Started
      ...
      <EcomProducts products={products} />
      </div>
